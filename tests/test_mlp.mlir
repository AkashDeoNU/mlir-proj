...
func.func @mlp(%x:  tensor<1x4xf64>,
               %W1: tensor<4x3xf64>, %b1: tensor<1x3xf64>,
               %W2: tensor<3x2xf64>, %b2: tensor<1x2xf64>) -> tensor<1x2xf64>
    attributes { llvm.emit_c_interface } {
  %z1 = nn.matmul %x,  %W1 : (tensor<1x4xf64>, tensor<4x3xf64>) -> tensor<1x3xf64>
  %a1 = nn.add    %z1, %b1 : (tensor<1x3xf64>, tensor<1x3xf64>) -> tensor<1x3xf64>
  %h1 = nn.relu   %a1      : tensor<1x3xf64> -> tensor<1x3xf64>
  %z2 = nn.matmul %h1, %W2 : (tensor<1x3xf64>, tensor<3x2xf64>) -> tensor<1x2xf64>
  %y  = nn.add    %z2, %b2 : (tensor<1x2xf64>, tensor<1x2xf64>) -> tensor<1x2xf64>
